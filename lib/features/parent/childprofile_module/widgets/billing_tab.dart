...
class BillingTab extends StatefulWidget {
  final int childId; // <-- dagdag

  const BillingTab({super.key, required this.childId});
...
class _BillingTabState extends State<BillingTab> {
  ...
  Future<void> _loadBilling() async {
    final data = await ApiService.getParentBilling(widget.childId.toString());
    if (mounted) {
      setState(() {
